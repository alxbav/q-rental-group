...
public class TransactionUseCaseController {
    ...
    public String addForm(final Model model) {
        ...
        model.addAttribute("positiveTransactionTypes", transactionTypeQuery.getByNegative(false));
        model.addAttribute("negativeTransactionTypes", transactionTypeQuery.getByNegative(true));
